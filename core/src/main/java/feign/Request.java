...
public final class Request implements Serializable {
     ...
     * @return a Request
     */
    public static Request create(HttpMethod httpMethod, // GET
                                 String url, // http://localhost:36616/hello
                                 Map<String, Collection<String>> headers,  //  size = 0
                                 Body body, // new Body()
                                 /**
                                  * GET http://localhost:36616/hello HTTP/1.1
                                  *
                                  * Binary data
                                  */
                                 RequestTemplate requestTemplate) {
